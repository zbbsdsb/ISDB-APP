      ...
      {loading ? (
        <View style={styles.centerContent}>
          <Skeleton
            ...
            width={120}
            height={32}
            style={{marginBottom: m3Spacing.lg}}
          />
                ...
                <View
                  ...
                  style={[
                    ...
                    // eslint-disable-next-line react-native/no-inline-styles
                    {
                      ...
                      borderColor: unlocked
                        ? TIER_COLORS[badge.tier] || colors.outline
                        : colors.outline,
                    },
                  ]}>
                  {badge.image_url ? (
                  ...
                  <Text
                    style={[
                      ...
                      {
                        color:
                          TIER_COLORS[badge.tier] || colors.onSurfaceVariant,
                      },
                    ]}>
