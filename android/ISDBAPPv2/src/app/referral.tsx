  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.header}>
        ...
        />
        <Text style={[styles.headerTitle, { color: colors.onBackground }]}>Invite Friends</Text>
        <View style={{ width: 48 }} />
      </View>
      ...
      {loading ? (
        ...
        <View style={styles.content}>
          {/* Referral code card */}
          <Card variant="elevated" padding={m3Spacing.xl} style={styles.codeCard}>
            <Text style={styles.emoji}>🎉</Text>
            <Text style={[styles.codeLabel, { color: colors.onSurfaceVariant }]}>Your Referral Code</Text>
            <Text style={[styles.codeValue, { color: colors.primary }]}>{code || 'ISDB-XXXXXX'}</Text>
          ...
          {/* Stats */}
          <Card variant="filled" padding={m3Spacing.md} style={styles.statsCard}>
            <View style={styles.statRow}>
              <Text style={[styles.statValue, { color: colors.primary }]}>{totalReferrals}</Text>
              <Text style={[styles.statLabel, { color: colors.onSurfaceVariant }]}>Friends Joined</Text>
            </View>
          </Card>
...
const styles = StyleSheet.create({
  ...
  codeValue: { ...m3Typography.headlineMedium, fontWeight: '700', letterSpacing: 2, marginBottom: m3Spacing.sm },
